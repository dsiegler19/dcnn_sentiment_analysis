...
import env.src.theano_dcnn.dataUtils as dataUtils
import env.src.theano_dcnn.networks as networks
import env.src.theano_dcnn.utils as utils
...
train_x_indexes, train_y, train_lengths = dataUtils.read_and_sort_matlab_data(kalchbrenner_path + "train.txt",
                                                                              kalchbrenner_path + "train_lbl.txt")
dev_x_indexes, dev_y, dev_lengths = dataUtils.read_and_sort_matlab_data(kalchbrenner_path + "valid.txt",
                                                                        kalchbrenner_path + "valid_lbl.txt")
test_x_indexes, test_y, test_lengths = dataUtils.read_and_sort_matlab_data(kalchbrenner_path + "test.txt",
                                                                           kalchbrenner_path + "test_lbl.txt")
...
for layer in lasagne.layers.get_all_layers(output_layer):
    if isinstance(layer, (
            env.src.sentiment_analysis.theano_dcnn.DCNN.embeddings.SentenceEmbeddingLayer, env.src.sentiment_analysis.theano_dcnn.DCNN.convolutions.Conv1DLayerSplitted, lasagne.layers.DenseLayer)):
